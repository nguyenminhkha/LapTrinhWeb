                ...
                <table style="width: 100%">
                    <tr>
                        <td>
                            ...
                            <asp:Button ID="Button3" runat="server" CssClass="btn-dongy" Text="Xác nhận" Height="36px" OnClick="Button3_Click" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lbxacnhan" runat="server" Font-Bold="True" Font-Size="Medium" ForeColor="#0066FF"></asp:Label>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
